                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        children: <Widget>[
                          Image.asset('assets/images/home_image_top.PNG'),
                        ],
                      ),
                    ),
                  ],
                    ...
                    SizedBox(
                      ...
                      child: const Column(
                        children: <Widget>[
                          ...
                          Text(
                              'Efficient course planning tools to save time for teachers..Efficient course planning tools to save time for teachers..Efficient course planning tools to save time for teachers..Efficient course planning tools to save time for teachers..Efficient course planning tools to save time for teachers..'),
                        ],
                      ),
                    ),
                  ],
